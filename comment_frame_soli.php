...
if (isset($_POST['postcomment' . $getid . ''])){
	...
	$insertpost= mysqli_query($con,"INSERT INTO post_comments_soli VALUES ('','$post_body','$username','$posted_to','0','$getid','$date')");
}
?>
...
<div id='toggleComment' style='display:none;'>
	<form action="comment_frame_soli.php?id=<?php echo htmlspecialchars($getid);?>" method="POST" name="postcomment<?php echo htmlspecialchars($getid);?>">
...
$get_comments=mysqli_query($con,"SELECT * FROM post_comments_soli WHERE post_id='$getid' ORDER BY id ASC");
